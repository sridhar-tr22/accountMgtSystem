...
public class AccountRepostoryTest {
	...
	public void addFundsToAccountTest() {
		...
		Account fetchedAccountForAddingBalance = findById.get();
		
		System.out.println("Fecthed Account Number: " + fetchedAccountForAddingBalance.getAccountNumber());
		System.out.println("Fecthed Account Balance: " + fetchedAccountForAddingBalance.getAccountBalanceAmount());
		
		
		BigDecimal accountBalanceAmount = fetchedAccountForAddingBalance.getAccountBalanceAmount();
		//accountBalanceAmount.add(augend)
		
		accountBalanceAmount.add(accountRequestObject.getAmmountToAdd());
		
		System.out.println("Balance Afte adding funds: " + accountBalanceAmount);
		
		fetchedAccountForAddingBalance.setAccountBalanceAmount(accountBalanceAmount);
		
		
		Account save = accountRepository.save(fetchedAccountForAddingBalance);
		
		
		System.out.println("Balance: " + save.getAccountBalanceAmount());
	}
